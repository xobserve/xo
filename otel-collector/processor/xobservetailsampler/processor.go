...
package xobservetailsampler // import "github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor"
...
const (
	sourceFormat = "xobserve_tail_sampling"
)
