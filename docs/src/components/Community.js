import { useChinese } from "./LangSwitch"
...
export function Community() {
  ...
  return (
    <ul className="grid sm:grid-cols-2 gap-6 xl:gap-8">
      <li>
        <a
          href="https://github.com/opendatav/datav/discussions"
        ...
        >
          ...
          <div className="flex-auto">
            <h3 className="font-bold text-gray-900">{isChinese ? 'Github讨论组' : 'GitHub Discussions'}</h3>
            <p>{isChinese? '进入位于Github的Datav讨论组，参与讨论你感兴趣的话题' : 'Connect with members of the Datav community.'}</p>
          </div>
        </a>
      </li>
      {/* <li>
      ...
      <li>
        <a href="https://twitter.com/open_datav" className="flex items-start space-x-4">
          ...
          <div className="flex-auto">
            ...
            <p>{isChinese ? '关注Datav，收到最新的更新和新闻' : 'Follow the Tailwind Twitter account for news and updates.'}</p>
          </div>
        </a>
      </li>
      {/* <li>
