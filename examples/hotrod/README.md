...
> This demo is copied from [Jaeger](https://github.com/jaegertracing/jaeger/tree/main/examples/hotrod) project, and we make some changes on the original codes
