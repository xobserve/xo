...
const (
	LogsSelectSQL = "SELECT " +
		"timestamp, id, trace_id, span_id, trace_flags, severity_text, severity_number, body, _namespace, _service, _host, " +
		"CAST((attributes_string_key, attributes_string_value), 'Map(String, String)') as  attributes"
