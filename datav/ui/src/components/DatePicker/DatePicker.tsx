        ...
        <>
                    ...
                    <HStack spacing={0} onClick={onOpen} cursor="pointer">
                        ...
                        </IconButton>}
                        {
                            showTime && <>
                                {
                                   <Box>
                                        {!isMobileScreen && <Text layerStyle="textSecondary" fontSize="0.95rem" fontWeight="500">
                                        ...
                                        { isLargeScreen && showRealTime && value.startRaw.toString().startsWith('now') &&
                                            <Text layerStyle="textSecondary" fontSize="0.95rem" fontWeight="500">
            ...
            <Modal isOpen={isOpen} onClose={onClose} initialFocusRef={null} autoFocus={false}>
                ...
                <ModalContent minW="fit-content">
                    <ModalBody>
                        <TimePicker onClose={onClose} onTimeChange={onTimeChange} initTimeRange={getNewestTimeRange()} />
                    </ModalBody>
