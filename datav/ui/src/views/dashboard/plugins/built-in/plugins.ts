...
import observexLogPanel from './panel/observexLog'
import observexTracePanel from './panel/observexTrace'

import prometheusDs from './datasource/prometheus'
import httpDs from './datasource/http'
import observexDs from './datasource/observex'
...
export const builtinPanelPlugins: Record<string,PanelPluginComponents> = {
    ...
    [observexLogPanel.settings.type]: observexLogPanel,
    [observexTracePanel.settings.type]: observexTracePanel
}
...
export const builtinDatasourcePlugins: Record<string,DatasourcePluginComponents> = {
    ...
    [observexDs.settings.type]: observexDs,
