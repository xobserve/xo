...
export const queryxobserveVariableValues = async (variable: Variable, useCurrentTimerange = true) => {
    let result = {
        error: null,
        data: null
    }
...
export const replacexobserveQueryWithVariables = (query: PanelQuery | string, interval: string) => {
