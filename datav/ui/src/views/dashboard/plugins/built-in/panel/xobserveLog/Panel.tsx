...
import XobserveLogChart from "../../../components/charts/ErrorOkChart";
            ...
            !isLogData(data[0])
                ...
                <Center height="100%">
                    <VStack>
                        ...
                        <Text className='color-text'>Try to change to xobserve datasource to use this panel</Text>
                    </VStack>
                </Center>
                :
    ...
    return (<>
        <Box px="2" height="100%" id="xobserve-log-panel" >
            {showChart && <Box key={showLogs as any} height={showLogs ? chartHeight: props.height} mb="2">
                <XobserveLogChart data={data.chart} onClick={onClickChart} totalCount={totalLogs} displayCount={showLogs ? displayLogCount : null} options={panel.plugins[PanelType].chart}/>
            </Box>}
