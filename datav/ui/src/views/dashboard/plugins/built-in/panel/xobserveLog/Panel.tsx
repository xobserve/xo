    ...
    return (<>
        <Box px="2" height="100%" id="xobserve-log-panel" >
            {showChart && <Box key={showLogs as any} height={showLogs ? chartHeight: props.height} mb="2">
                <ErrorOkChart data={data.chart} onClick={onClickChart} totalCount={totalLogs} displayCount={showLogs ? displayLogCount : null} options={panel.plugins[PanelType].chart}/>
            </Box>}
