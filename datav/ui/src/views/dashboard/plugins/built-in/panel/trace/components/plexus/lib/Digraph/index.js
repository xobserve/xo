...
export default class Digraph extends React.PureComponent {
  ...
  renderLayers() {
    ...
    return topLayers.map(layer => {
      ...
      if (layer.edges) {
        ...
        return layoutPhase === ELayoutPhase.Done ? /*#__PURE__*/React.createElement(SvgEdgesLayer, {
          key: key,
          standalone: true,
          getClassName: getClassName,
          defs: defs,
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", rootProps, /*#__PURE__*/React.createElement("div", {
      style: builtinStyle,
      ref: this.rootRef
    }, this.renderLayers()), minimapEnabled && this.zoomManager && /*#__PURE__*/React.createElement(MiniMap, Object.assign({
