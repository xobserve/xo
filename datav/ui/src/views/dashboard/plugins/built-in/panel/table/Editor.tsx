        ...
        {panel.plugins.table.rowActions.length > 0 && (
          <>
            <PanelEditItem title={t1.actionColumnName}>
              <EditorInputItem
                value={panel.plugins.table.actionColumnName}
                placeholder='default to Action when leave empty'
                onChange={(v) =>
                  onChange((panel: Panel) => {
            ...
            <PanelEditItem title={t1.actionColumnWidth}>
              <EditorInputItem
                value={panel.plugins.table.actionClumnWidth}
                placeholder='css width, e.g 100px, 20%'
                onChange={(v) =>
                  onChange((panel: Panel) => {
            ...
            <PanelEditItem title={t1.actionButtonSize}>
              <RadionButtons
                ...
                value={panel.plugins.table.actionButtonSize}
                onChange={(v) =>
                  onChange((panel: Panel) => {
