...
export class Emitter {
  ...
  //@ts-ignore
  emit<T extends Partial<T> extends T ? Partial<T> : never>(
    event: AppEvent<T>,
  ): void
   ...
   */
  on<T extends undefined>(
    event: AppEvent<T>,
    handler: () => void,
    scope?: any,
  ): void
  //@ts-ignore
  on<T extends Partial<T> extends T ? Partial<T> : never>(
    event: AppEvent<T>,
    handler: () => void,
    scope?: any,
  ): void
  ...
  //@ts-ignore
  off<T extends Partial<T> extends T ? Partial<T> : never>(
    event: AppEvent<T>,
    handler: () => void,
    scope?: any,
  ): void
