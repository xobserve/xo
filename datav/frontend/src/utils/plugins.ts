...
export const queryPluginDataToTimeSeries = (
...
export const queryPluginDataToTable = (
  data: QueryPluginData,
  query: PanelQuery,
) => {
...
export const queryPluginDataToValueList = (
  data: QueryPluginData,
  query: PanelQuery,
) => {
...
export const queryPluginDataToLogs = (
  data: {
...
export const queryPluginDataToNodeGraph = (
  data: QueryPluginData,
  query: PanelQuery,
) => {
  if (!data.columns) {
