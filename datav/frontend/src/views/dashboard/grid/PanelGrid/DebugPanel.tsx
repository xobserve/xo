...
const PanelAnnotations = ({ dashboardId, panel }: PanelAnnotationsProps) => {
  ...
  const annotations = useStore($rawDashAnnotations)
    .filter((a) => a.group === panel.id)
