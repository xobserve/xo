    ...
    <>
      <PanelAccordion title={t.basic}>
        <PanelEditItem title={t.animation} desc={t.animationTips}>
          <Switch
            defaultChecked={panel.plugins.bar.animation}
            onChange={(e) =>
              onChange((panel: Panel) => {
        ...
        <PanelEditItem title='Show grid'>
          <Switch
            defaultChecked={panel.plugins.bar.showGrid}
            onChange={(e) =>
              onChange((panel: Panel) => {
        ...
        <PanelEditItem title='Tooltip'>
          <RadionButtons
            ...
            value={panel.plugins.bar.tooltip}
            onChange={(v) =>
              onChange((panel: Panel) => {
        ...
        <PanelEditItem title='Show label' desc='Value label display on bars'>
          <RadionButtons
            ...
            value={panel.plugins.bar.showLabel}
            onChange={(v) =>
              onChange((panel: Panel) => {
      ...
      <PanelAccordion title={'Axis'}>
        <PanelEditItem title='Swap XY'>
          <Switch
            defaultChecked={panel.plugins.bar.axis.swap}
            onChange={(e) =>
              onChange((panel: Panel) => {
        ...
        <PanelEditItem title={t.scale}>
          <RadionButtons
            ...
            value={panel.plugins.bar.axis.scale}
            onChange={(v) =>
              onChange((panel: Panel) => {
        ...
        {panel.plugins.bar.axis.scale == 'log' && (
          <PanelEditItem title='Scale Base'>
            <RadionButtons
              ...
              value={panel.plugins.bar.axis.scaleBase as any}
              onChange={(v) =>
                onChange((panel: Panel) => {
      ...
      <PanelAccordion title='Legend'>
        <PanelEditItem title={t.show}>
          <Switch
            defaultChecked={panel.plugins.bar.legend.show}
            onChange={(e) =>
              onChange((panel: Panel) => {
          ...
          <>
            <PanelEditItem title={t1.placement}>
              <RadionButtons
                ...
                value={panel.plugins.bar.legend.placement}
                onChange={(v) =>
                  onChange((panel: Panel) => {
            ...
            {panel.plugins.bar.legend.placement == 'right' && (
              <PanelEditItem title={t1.width}>
                <EditorNumberItem
                  value={panel.plugins.bar.legend.width}
                  min={100}
                  step={50}
                  onChange={(v) =>
                    onChange((panel: Panel) => {
                      panel.plugins.bar.legend.width = v <= 100 ? 100 : v
                    })
                  }
                />
              </PanelEditItem>
            ...
            {panel.plugins.bar.legend.placement == 'right' && (
              <PanelEditItem title={t1.nameWidth} desc={t1.nameWidthTips}>
                <EditorInputItem
                  value={panel.plugins.bar.legend.nameWidth}
                  onChange={(v) =>
                    onChange((panel: Panel) => {
            ...
            <PanelEditItem title={t1.values} desc={t1.valuesTips}>
              <PopoverSelect
                value={panel.plugins.bar.legend.valueCalcs}
                isMulti
      ...
      <PanelAccordion title={t.styles}>
        <PanelEditItem title='Bar width'>
          <EditorNumberItem
            value={panel.plugins.bar.styles.barWidth}
            min={1}
            max={100}
            step={2}
            onChange={(v) =>
              onChange((panel: Panel) => {
                panel.plugins.bar.styles.barWidth = v
              })
            }
            placeholder='auto'
          />
        ...
        <PanelEditItem title='Axis font size'>
          <EditorNumberItem
            value={panel.plugins.bar.styles.axisFontSize}
            min={6}
            max={20}
            step={1}
            onChange={(v) =>
              onChange((panel: Panel) => {
                panel.plugins.bar.styles.axisFontSize = v
              })
            }
            placeholder='auto'
          />
        ...
        <PanelEditItem title='Label font size'>
          <EditorNumberItem
            value={panel.plugins.bar.styles.labelFontSize}
            min={6}
            max={20}
            step={1}
            onChange={(v) =>
              onChange((panel: Panel) => {
                panel.plugins.bar.styles.labelFontSize = v
              })
            }
            placeholder='auto'
          />
        ...
        <PanelEditItem title='Bar fill opacity'>
          <EditorSliderItem
            value={panel.plugins.bar.styles.barOpacity}
            min={10}
            max={100}
            step={1}
            onChange={(v) =>
              onChange((panel: Panel) => {
                panel.plugins.bar.styles.barOpacity = v
              })
            }
          />
        </PanelEditItem>
      ...
      <PanelAccordion title={t.valueSettings}>
        ...
        <PanelEditItem title={t.decimal}>
          <EditorNumberItem
            value={panel.plugins.bar.value.decimal}
            min={0}
            max={5}
            step={1}
            onChange={(v) =>
              onChange((panel: Panel) => {
                panel.plugins.bar.value.decimal = v
              })
            }
          />
        </PanelEditItem>
      ...
      <PanelAccordion title='Thresholds'>
        ...
        <PanelEditItem title={t1.thresholdsDisplay}>
          ...
          >
            <option value={ThresholdDisplay.None}>
              {ThresholdDisplay.None}
            </option>
            <option value={ThresholdDisplay.Line}>
              {ThresholdDisplay.Line}
            </option>
            <option value={ThresholdDisplay.DashedLine}>
              {ThresholdDisplay.DashedLine}
            </option>
          </Select>
        </PanelEditItem>
