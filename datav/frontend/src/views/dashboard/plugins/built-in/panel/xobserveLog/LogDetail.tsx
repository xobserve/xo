      ...
      <DrawerContent>
        <DrawerBody fontSize='0.9rem' py='6' px='4'>
          <Flex gap={2} alignItems='center'>
            <Text opacity={!isError && 0.7} className={isError && 'error-text'}>
              {log.severityText} at{' '}
            </Text>
          ...
          <Tabs size='sm' mt='4'>
            ...
            <TabPanels>
              <TabPanel>
                ...
                <Text fontWeight={550} mt='4' fontSize='0.85rem'>
                  Resources
                </Text>
                <Divider mt='2' />
...
const LogKV = ({ k, v, onSearch }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Tooltip label='Add to current search'>
          <Box cursor='pointer'>
            <FaSearchPlus onClick={() => onSearch(false)} />
          </Box>
        </Tooltip>
        <Tooltip label='Search with this value'>
          <Box cursor='pointer'>
            <FaSearch onClick={() => onSearch(true)} />
          </Box>
        </Tooltip>
        <CopyToClipboard
          copyText={v}
          tooltipTitle='copy this value'
          fontSize='0.7rem'
        />
      </HStack>
    </Flex>
