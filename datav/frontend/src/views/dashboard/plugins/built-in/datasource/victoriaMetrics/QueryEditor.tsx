  ...
  return (
    <Form spacing={1}>
        ...
        <Stack width='100%' alignItems={isLargeScreen ? 'center' : 'end'}>
          ...
          <HStack spacing={1}>
            ...
            <Box
              onClick={() =>
                window.open(
                  `${ds.url}/vmui/#/expand-with-exprs?expr=${tempQuery.metrics}`,
                )
              }
      ...
      >
        ...
        >
          <Switch
            defaultChecked={tempQuery.data['traceQuery']}
            onChange={(e) => {
        ...
        <FormItem
          ...
          title='View in vmui'
          alignItems='center'
          desc='Open vmui to view curren metrics'
          onLabelClick={() =>
            window.open(`${ds.url}/vmui?g0.expr=${tempQuery.metrics}`)
          }
        ></FormItem>
      ...
      {queryData?.trace && (
        <TraceQuery data={queryData.trace} query={queryStr} />
      )}
    </Form>
  )
}
