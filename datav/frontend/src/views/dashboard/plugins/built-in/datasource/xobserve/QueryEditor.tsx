    ...
    <>
      <Form spacing={1}>
        ...
        >
          ...
          />
          {!isMobileScreen && api?.desc && (
            <Text textStyle='annotation'>{api.desc}</Text>
          )}
        </FormItem>
        {api?.params && (
          <FormItem
          ...
          >
            <Box
              width={
                !isMobileScreen ? 'calc(100% - 200px)' : 'calc(100% - 180px)'
              }
            >
              <CodeEditor
                language='json'
...
export const apiList = [
  ...
  },
  {
    ...
    paramsDesc: [...domainParams, ['service', 'service name']],
    format: DataFormat.ValueList,
  },
  {
  ...
  },
  {
    ...
    paramsDesc: [
      ...
      [
        'severity',
        'logs severity, e.g error|info',
        '',
        'debug| info | warn | error | fatal',
      ],
      [
        'perPage',
        'page size of logs when query from datasource',
        '100',
        'any number',
      ],
