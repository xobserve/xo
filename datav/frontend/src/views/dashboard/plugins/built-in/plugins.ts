...
import xobserveLogPanel from './panel/xobserveLog'
import xobserveTracePanel from './panel/xobserveTrace'
...
export const builtinPanelPlugins: Record<string, PanelPluginComponents> = {
  ...
  [xobserveLogPanel.settings.type]: xobserveLogPanel,
  [xobserveTracePanel.settings.type]: xobserveTracePanel,
}

export const builtinDatasourcePlugins: Record<
  string,
