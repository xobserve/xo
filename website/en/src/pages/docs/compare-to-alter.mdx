...
### Better panel plugins

Some plugins in Datav are significantly better than Grafana, such as: 

<TextList>
<li>[NodeGraph](/docs/plugin-nodegraph), for dependency graph display </li>
<li> [Echarts](/docs/plugin-echarts), for general purporse chart</li>
<li> [Trace](/docs/plugin-trace)</li>
<li> [Logs](/docs/plugin-log)</li>
</TextList>
These panels are better than grafana doesn't mean Datav is better than Grafana, it is just because we are mainly for Observability and APM scenario, and these panels are the core of APM dashboards.
