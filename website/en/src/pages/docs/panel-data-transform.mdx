...
<img src={require('@/img/docs/dashboard/panel-data-transform.jpg').default.src} alt="panel-data-transform" width={3086} height={1658} className="rounded-lg ring-1 ring-black/5" />
...
<img src={require('@/img/docs/dashboard/transform-option.jpg').default.src} alt="transform-option" style={{height: "400px"}} className="rounded-lg ring-1 ring-black/5" />


After doing this, the `Time` column of Table should show time string instead of the previous timestamp:


<img src={require('@/img/docs/dashboard/transformed-table.jpg').default.src} alt="transformed-table" style={{height: "260px"}} className="rounded-lg ring-1 ring-black/5" />
...
<img src={require('@/img/docs/dashboard/panel-query.jpg').default.src} alt="panel-query" width={3086} height={1658} className="rounded-lg ring-1 ring-black/5" />
