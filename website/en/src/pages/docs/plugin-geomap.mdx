...
<TextList>
    <li>Country code `US`,  defined in [countries.json](https://github.com/data-observe/datav/blob/main/ui/public/plugins/panel/geomap/countries.json) </li>
    <li>City names `Shanghai`, defined in [cities.json](https://github.com/data-observe/datav/blob/main/ui/public/plugins/panel/geomap/cities.json)</li>
