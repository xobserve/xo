...
In this doc, we will use [Prometheus](https://prometheus.io/)  as datasource to build a dashboard, so you need to install it first, and make sure the Prometheus server is running.
