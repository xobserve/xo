...
We can see the map is too large, we can not see the whole world, let's focus to a country, let's assume you are from China, and you want to focus to China.
...
This is left to our readers as an exercise, the answer is in the last section of this tutorial.
...
Now, we have two panels in our dashboard, but they are quite small, particularly the Geomap panel, let's adjust their size and position.
