...
<img src="https://github.com/data-observe/assets/blob/main/variable/http-datasource.jpg?raw=true" style={{height: "400px"}}/>

## Create http Variable

Let's create a variable named `operation` to query data from jaeger http api: `http://localhost:16686/api/services/frontend/operations`.
...
<img src="https://github.com/data-observe/assets/blob/main/variable/basic-http.jpg?raw=true" style={{height: "500px"}}/>

You should have noticed, we have use a `service` variable in  `Query values` field: `http://localhost:16686/api/services/${service}/operations`, which means **we can use variable in HTTP request url**.
...
<img src="https://github.com/data-observe/assets/blob/main/variable/http-variable.jpg?raw=true" style={{height: "500px"}}/>
...
<video controls autoplay src="https://github.com/data-observe/assets/blob/main/variable/http-final.mov?raw=true" style={{height: "500px"}}/>
