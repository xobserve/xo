...
![request duration stats](https://github.com/data-observe/assets/blob/main/tutorial/alert-page.jpg?raw=true)
...
![request duration stats](https://github.com/data-observe/assets/blob/main/tutorial/alert-filter.jpg?raw=true)

3. Add `prometheus` datasource to `Datasource` filter, and remove `TestData` datasource.

You should see the reult as below: 

<img src="https://github.com/data-observe/assets/blob/main/tutorial/alert-prometheus-ds.jpg?raw=true" />


Here we successfully query the real alerts from Prometheus, let's have a deep view into this alert rule.

<img src="https://github.com/data-observe/assets/blob/main/tutorial/alert-rule.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/home-dashboard.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/home-graph-panel.jpg?raw=true" style={{height: '400px'}} />
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/select-panel-border.jpg?raw=true" style={{height: '200px'}} />

3. For convenient, just select no border for now

<img src="https://github.com/data-observe/assets/blob/main/tutorial/panel-border-list.jpg?raw=true" style={{height: '300px'}} />

4. Same to panel decoration, find `Panel decoration` section and  set it to none 

<img src="https://github.com/data-observe/assets/blob/main/tutorial/panel-decoration.jpg?raw=true" style={{height: '500px'}} />

Now, you should see a Graph panel like this:

<img src="https://github.com/data-observe/assets/blob/main/tutorial/none-border-panel.jpg?raw=true"  />
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/alert-correlation.jpg?raw=true" style={{height: '500px'}} />


If everything is ok, you should see a Graph panel like this:

<img src="https://github.com/data-observe/assets/blob/main/tutorial/graph-alerts.jpg?raw=true"  />
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/panel-alerts-detail.jpg?raw=true"  />

It is very similar to `/alert` page, but here you can see the alerts and Graph at the same place.


> For more info about alert settings, please visit [Alert settings](/docs/alert-setting)