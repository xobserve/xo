    ...
    <>
      ...
      >
        <div className="max-w-8xl mx-auto">
          <div
            className={clsx(
              'py-3 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10',
          ...
          >
            <div className="relative flex items-center">
              ...
              {/* <VersionSwitcher /> */}
              {/* <Featured /> */}
              <SearchButton className="ml-4 hidden sm:flex items-center w-72 text-left space-x-3 px-4 py-4 h-6 bg-white ring-1 ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 shadow-sm rounded-lg text-slate-400 dark:bg-slate-800 dark:ring-0 dark:text-slate-300 dark:highlight-white/5 dark:hover:bg-slate-700">
                {({ actionKey }) => (
                  <>
                    <svg
                      width="24"
