...
<TextList>
    <li> 国家编码 `US`，坐标索引定义在 [countries.json](https://github.com/data-observe/datav/blob/main/ui/public/plugins/panel/geomap/countries.json) </li>
    <li> 城市名称 `Shanghai`, 坐标索引定义在 cities.json](https://github.com/data-observe/datav/blob/main/ui/public/plugins/panel/geomap/cities.json)</li>
