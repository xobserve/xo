...
<img src="https://github.com/data-observe/assets/blob/main/panel/panel-with-two-queries.jpg?raw=true" style={{height: "260px"}}/>
...
<img src="https://github.com/data-observe/assets/blob/main/panel/fill-area.jpg?raw=true" style={{height: "260px"}}/>

### unit 

Now, let's set the unit of all series in the chart:

<img src="https://github.com/data-observe/assets/blob/main/panel/unit.jpg?raw=true" style={{height: "260px"}}/>

It should be noted that value in `Unit` is actually ` / load5` with a `space` char at the beginning.

<img src="https://github.com/data-observe/assets/blob/main/panel/panel-with-common-options.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/panel/override-item.jpg?raw=true" />

### Add Y-axis override

Click `Add override rule` and select `Series.separateYAxis` type ,then enable it as below: 

<img src="https://github.com/data-observe/assets/blob/main/panel/yaxis-override.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/panel/override-unit.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/panel/negativey-override1.jpg?raw=true" />
...
<img src="https://github.com/data-observe/assets/blob/main/panel/styles-override.jpg?raw=true" style={{height: "400px"}}/>
...
<TextList>
    ...
    <li>Remove the line from chartSet by seting `Series.lineWidth` to 0 </li>
...
<img src="https://github.com/data-observe/assets/blob/main/panel/override-final.jpg?raw=true" style={{height: "300px"}}/>