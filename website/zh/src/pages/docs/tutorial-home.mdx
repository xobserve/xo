...
![](https://github.com/data-observe/assets/blob/main/tutorial/pretty-dashboard.jpg?raw=true)
...
<img src="https://github.com/data-observe/assets/blob/main/tutorial/dashboard-history.jpg?raw=true" style={{height: "500px"}} />
...
1. Revert to a history version
2. Setting `backgrond enable` to `off`

Then change theme again, you will see the background color is changed.
...
![panel header](https://github.com/data-observe/assets/blob/main/tutorial/panel-header.jpg?raw=true)
