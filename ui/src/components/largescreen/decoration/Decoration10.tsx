...
const Decoration10 = forwardRef(({ className, style, color = [] }:DecorationProps, ref) => {
  ...
  return (
    <Box className={classNames} style={style} ref={domRef} width="100%" height="100%" display="flex">
