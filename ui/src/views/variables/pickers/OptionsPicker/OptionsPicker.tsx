...
import { ClickOutsideWrapper } from 'src/packages/datav-core/src/ui';
...
import { VariableOption, VariableTag, VariableWithMultiSupport, VariableWithOptions } from 'src/types';
