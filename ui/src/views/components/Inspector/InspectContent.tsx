...
import { DataSourceApi, PanelData, PanelPlugin } from 'src/packages/datav-core/src';
import { getTemplateSrv } from 'src/packages/datav-core/src';
import { CustomScrollbar, Drawer, TabContent } from 'src/packages/datav-core/src';
    ...
    >
      ...
      <CustomScrollbar autoHeightMin="100%">
        <TabContent className={styles.tabContent}>
          ...
          {data && activeTab === InspectTab.Stats && <InspectStatsTab data={data} timeZone={getTimeSrv().timezone} />}
