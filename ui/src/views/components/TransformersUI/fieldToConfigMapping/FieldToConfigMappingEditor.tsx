...
import { DataFrame, getFieldDisplayName, GrafanaTheme2, ReducerID, SelectableValue } from 'src/packages/datav-core/src';
import { Select, StatsPicker, useStyles2 } from 'src/packages/datav-core/src/ui';
