...
import { DataTransformerID, standardTransformers, TransformerRegistryItem, TransformerUIProps } from 'src/packages/datav-core/src';

import {
  HistogramTransformerOptions,
  histogramFieldInfo,
} from 'src/packages/datav-core/src/data/transformations/transformers/histogram';
import { InlineField, InlineFieldRow, InlineSwitch, Input } from 'src/packages/datav-core/src/ui';
