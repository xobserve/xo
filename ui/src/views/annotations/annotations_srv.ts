...
import { getBackendSrv, getDataSourceService } from 'src/packages/datav-core/src/runtime';
...
import { RefreshEvent } from 'src/types/events';
...
import { runRequest } from '../dashboard/model/runRequest';
