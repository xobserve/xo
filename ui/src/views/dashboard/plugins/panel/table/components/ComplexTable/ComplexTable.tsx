...
const ComplexTable = memo((props: Props) => {
  ...
  return (<>
    <Table
      ...
      pagination={options.enablePagination ? { total: data.length, showSizeChanger: true, defaultPageSize: storage.get(pageKey) ?? 10, pageSizeOptions: [5, 10, 20, 50, 100], onShowSizeChange: onShowSizeChange } : false}
