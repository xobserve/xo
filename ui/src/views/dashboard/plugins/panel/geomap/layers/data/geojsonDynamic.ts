...
import { FeatureRuleConfig, FeatureStyleConfig, MapLayerOptions, MapLayerRegistryItem } from '../../types';
...
import { PluginState } from '../../utils/registry';
import { findField } from '../../utils/dimensions/utils';
...
export const dynamicGeoJSONLayer: MapLayerRegistryItem<DynamicGeoJSONMapperConfig> = {
   ...
   * @param theme
   */
  create: async (map: OlMap, options: MapLayerOptions<DynamicGeoJSONMapperConfig>,  theme: any) => {
