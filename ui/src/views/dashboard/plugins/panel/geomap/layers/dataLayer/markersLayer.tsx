...
import { FrameGeometrySourceMode, MapLayerOptions, MapLayerRegistryItem } from '../../types';
import { FrameVectorSource } from '../../utils/frameFromSource';
...
export const markersLayer: MapLayerRegistryItem<MarkersConfig> = {
   ...
   * @param theme
   */
  create: async (map: Map, options: MapLayerOptions<MarkersConfig>, theme: any) => {
