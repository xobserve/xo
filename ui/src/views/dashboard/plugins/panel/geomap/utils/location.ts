...
import { FrameGeometrySource, FrameGeometrySourceMode } from '../types';

export type FieldFinder = (frame: SeriesData) => Field | undefined;
export type FieldMatcher = (field: Field, frame: SeriesData, allFrames: SeriesData[]) => boolean;
...
export function getFieldMatcher(config: any): FieldMatcher {
    return  null
...
const defaultMatchers: LocationFieldMatchers = {
    ...
    geo: (frame: SeriesData) => frame.fields.find((f) => f.type === FieldType.Geo),
};
...
export function getLocationFields(frame: SeriesData, location: LocationFieldMatchers): LocationFields {
...
export function getGeometryField(frame: SeriesData, location: LocationFieldMatchers): FrameGeometryField {
