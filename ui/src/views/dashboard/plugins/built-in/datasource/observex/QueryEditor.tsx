...
export const apiList = [{
    ...
    paramsDesc: [
        ...domainParams,
        ["service", "filter by service names, e.g observex|driver"]
    ],
...
},
{
    ...
    paramsDesc: [
        ...domainParams,
        ["service", "filter by service names, e.g observex|driver", "", ""],
        ["host", "filter by host names, e.g observex-1|observex-2", "", ""],
...
},
{
    ...
    paramsDesc: [
      ...domainParams,
        ["source", "service name list, e.g observex|mysql","",""],
        ["target", "service name list, e.g observex|mysql","",""]
    ],
