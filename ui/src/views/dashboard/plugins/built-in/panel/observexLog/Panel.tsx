...
import { observexLogPanel, PanelType } from "./types";
...
import ObservexLogChart from "../../../components/charts/ErrorOkChart";
            ...
            !isLogData(data[0])
                ...
                <Center height="100%">
                    <VStack>
                        ...
                        <Text className='color-text'>Try to change to observex datasource to use this panel</Text>
                    </VStack>
                </Center>
                :
...
const Panel = (props: Props) => {
    ...
    return (<>
        <Box px="2" height="100%" id="observex-log-panel" >
            {showChart && <Box key={showLogs as any} height={showLogs ? chartHeight: props.height} mb="2">
                <ObservexLogChart data={data.chart} onClick={onClickChart} totalCount={totalLogs} displayCount={showLogs ? displayLogCount : null} options={panel.plugins[PanelType].chart}/>
            </Box>}
