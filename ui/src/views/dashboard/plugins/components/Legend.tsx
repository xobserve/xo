                                        ...
                                        <Box width="10px" minWidth="10px" height="4px" background={v.color} mt="7.5px"></Box>
                                            
                                            {
                                                (options.legend.placement == "bottom") ?
                                                    ...
                                                    :
                                                    <Text w={options.legend.nameWidth === "full" ? "100%" : options.legend.nameWidth + 'px'} noOfLines={3} wordBreak="break-all" whiteSpace={options.legend.nameWidth === "full" ? "nowrap" : "break-spaces"}>{v.name}</Text>
                                            }
