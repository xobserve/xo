        ...
        <>
            <PageContainer fullscreen={fullscreen} bg={dashboard?.data.styles?.bg}>
                {dashboard && <Box pl="6px" pr="6px" width="100%">
                    <BorderBox13 style={{width:"100%", height:"500px"}} reverse><Box height="100%" width="100%" display="flex" alignItems="center" justifyContent="center">dv-border-box-1</Box></BorderBox13>
