...
const DashboardRefresh = () => {
    ...
    return (<>
        ...
        <Box sx={{
            ...
            <Select popupMatchSelectWidth={false} bordered={false} value={refresh} onChange={(v) => onRereshChange(v)} options={[REFRESH_OFF,'5s','10s','30s', '1m','5m','10m'].map(v => ({value:v,label:v}))}/>
        </Box>
    </>)
}
