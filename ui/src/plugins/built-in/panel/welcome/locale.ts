...
const enData = {
    ...
    viewDocs: 'View Docs',
    subTitle: ` is fast, lightweight, intuitive, make it easy for users to visualize their data, from simple line charts to highly customized charts.`,
...
const zhData = {
    ...
    sloganSecond: 'metrics, traces and logs.',
    viewDocs: '查看文档',
    subTitle: `在保持轻量的同时又具备很高的性能，通过内置插件和第三方开发插件，为用户带来的强大的功能特性和极致的产品体验`,
    feature1Title: `强大且简单`,
