  ...
  return (
    <>
      <div className={styles.header}>
        ...
        <Row justify="center" align="top" className="ub-mt4">
          <Col span="7" style={{ paddingTop: '5px' }}>
            <h1 style={{ fontSize: '28px' }}>
              <FormattedMessage id="welcomePanel.sloganFirst"/>
               <span className="display-block color-teal">metrics, traces and logs.</span>
            </h1>
          ...
          <Col span="15">
            <div className="display-block ub-ml4" style={{ backgroundImage: 'url(/img/screenshot1.jpg)', height: '450px', backgroundSize: 'cover' }}></div>
          </Col>
        </Row>
      </div>
      ...
      <Row justify="center" className={styles.features}>
        <Col span="6" className={styles.featureCard}>
          <div>
            ...
            <h2> <FormattedMessage id="welcomePanel.feature1Title"/></h2>
            <p className={styles.featureDesc}><FormattedMessage id="welcomePanel.feature1Desc"/></p>
          </div>
        </Col>
        <Col span="6" offset="2" className={styles.featureCard}>
          <div>
            ...
            <h2> <FormattedMessage id="welcomePanel.feature2Title"/></h2>
      ...
      <Row justify="center" className={styles.features}>
        <Col span="6" className={styles.featureCard}>
          <div>
            ...
            <h2> <FormattedMessage id="welcomePanel.feature3Title"/></h2>
            <p className={styles.featureDesc}>{getBootConfig().common.appName}<FormattedMessage id="welcomePane.feature3Desc"/></p>
          </div>
        </Col>
        <Col span="6" offset="2" className={styles.featureCard}>
          <div>
            ...
            <h2> <FormattedMessage id="welcomePanel.feature4Title"/></h2>
...
const getStyles = stylesFactory((theme: DatavTheme) => {
  ...
  const navBorder = theme.isDark ? `1px solid rgb(237, 242, 247);` : `2px solid rgb(237, 242, 247);`
