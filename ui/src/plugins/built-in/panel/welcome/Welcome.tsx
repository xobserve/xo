        ...
        <Row justify="center">
          <Col span="22">
            <Row justify="space-between" align="middle" className={styles.nav}>
              ...
              <div>
              {props.options.showGithub && <a href={!props.options.githubAddr ? "https://github.com/savecost/datav" : props.options.githubAddr} target="_blank" className={cx(styles.getStarted, 'bg-primary')}>GITHUB <Icon name="github" size="xl"  /></a>}
