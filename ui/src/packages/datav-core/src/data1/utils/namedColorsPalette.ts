...
export const getColorDefinition = (hex: string, theme: ThemeType): ColorDefinition | undefined => {
...
export const getColorName = (color?: string, theme?: ThemeType): Color | undefined => {
  if (!color) {
    return undefined;
  }
  ...
  if (isHex(color)) {
    const definition = getColorDefinition(color, theme || ThemeType.Dark);
...
export const getColorFromHexRgbOrName = (color: string, theme?: ThemeType): string => {
...
export const getColorForTheme = (color: ColorDefinition, theme?: ThemeType) => {
