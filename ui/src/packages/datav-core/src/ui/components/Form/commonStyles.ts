...
import {ButtonVariant,StyleProps} from '../Button'

export const getFocusStyle = (theme: DatavTheme) => css`
  &:focus {
    ${focusCss(theme)}
  }
`;

export const sharedInputStyle = (theme: DatavTheme, invalid = false) => {
