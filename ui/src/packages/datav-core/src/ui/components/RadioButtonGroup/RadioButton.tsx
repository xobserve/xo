...
import { getPropertiesForButtonSize } from '../Form/commonStyles';
...
const getRadioButtonStyles = stylesFactory((theme: DatavTheme, size: RadioButtonSize, fullWidth?: boolean) => {
