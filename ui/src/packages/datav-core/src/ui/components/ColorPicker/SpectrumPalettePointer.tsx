...
export interface SpectrumPalettePointerProps  {
  direction?: string;
}

const SpectrumPalettePointer: React.FunctionComponent<SpectrumPalettePointerProps> = ({ direction }) => {
  const styles = {
    picker: {
      width: '16px',
      height: '16px',
