...
import { Dashboard, DatasourceType, PanelDatasource } from "types/dashboard"
...
const TeamsPage = () => {
    ...
    const [datasource, setDatasource] = useImmer<Datasource>(initDatasource)
    ...
    const addDatasource = async () => {
        ...
        setTimeout(() => {
            router.push(`/cfg/datasource?id=${res.data}`)
        }, 1000)
    }
